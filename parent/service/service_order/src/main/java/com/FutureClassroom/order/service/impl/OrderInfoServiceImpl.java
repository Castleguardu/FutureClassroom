...
import com.FutureClassroom.order.mapper.OrderInfoMapper;
import com.FutureClassroom.order.service.OrderDetailService;
import com.FutureClassroom.order.service.OrderInfoService;
...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    public Map<String, Object> selectOrderInfoPage(Page<OrderInfo> pageParam,
        ...
        //调用实现条件分页查询
        Page<OrderInfo> pages = baseMapper.selectPage(pageParam, wrapper);//主要是这块地方
