...
import com.FutureClassroom.vod.service.FileService;
import com.FutureClassroom.vod.utils.ConstantPropertiesUtil;
...
public class FileServiceImpl implements FileService {
    ...
    public String upload(MultipartFile file) {
        ...
        String secretId = ConstantPropertiesUtil.ACCESS_KEY_ID;   //这个地方千万注意，上传到github时一定要改的
        ...
        try{
            ...
            // 则表示将文件 picture.jpg 上传到 folder 路径下,让文件名称每次不一致
